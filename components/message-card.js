			...
			<div class="card">
				<div class="row">
					...
					<div class="right">
						...
						<button part="delete" class="delete-button" data-tooltip="Delete message">
							<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 256 256" height="100%" width="100%" fill="currentColor">
								<path
